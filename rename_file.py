...
def rename_number(path_list, path_4_list, file_list):
    for file in file_list:
        #数字だけ抜き出し
        path_1 = file.split(".")[1]
        path_2 = path_1.split("/")[4]  #004400の部分が格納されているはず
...
rename_number(path_list, file_list)
...
group_1 = [
    ...
    '119', '120', '121', '122', '321', '322', '323', '324', '325', '326',
    ...
    '567', '568', '1051', '1052', '1053', '1054', '1055', '1056', '1057',
...
group_2 = [
    ...
    '313', '314', '315', '316', '317', '318', '319', '320', '569', '570',
